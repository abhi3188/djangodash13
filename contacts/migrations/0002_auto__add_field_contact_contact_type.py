...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.contact_type'
        db.add_column(u'contacts_contact', 'contact_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'contacts_contact', 'contact_type')
    ...
    models = {
        ...
        u'contacts.contact': {
            ...
            'contact_type': ('django.db.models.fields.IntegerField', [], {'default': '4'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
